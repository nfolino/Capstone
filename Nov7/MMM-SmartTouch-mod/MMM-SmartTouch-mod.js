...
Module.register("MMM-SmartTouch-mod", {
  defaults: {
  },
  ...
  getStyles: function () {
    return [this.file("css/mmm-smarttouch-mod.css"), "font-awesome.css"];
  },
  ...
  createStandByButtonDiv: function () {
    ...
    standByButtonDiv.className = "myButton";//"st-container__standby-button";

    standByButtonDiv.appendChild(document.createElement("span"));
    standByButtonDiv.addEventListener("click", () => this.toggleColor());
